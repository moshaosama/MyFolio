  ...
  return (
    <>
      <div>
        ...
        {isOpenChatBot && (
          <div className="border-2 rounded-xl z-50  text-white fixed right-10 bottom-24 border-gray-500 w-[30pc] overflow-y-scroll h-[30pc]">
            ...
            <form
              className="fixed bottom-[6.5pc] w-[28pc]"
