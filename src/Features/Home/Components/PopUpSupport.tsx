...
Thank you for supporting Selfolio! Your contribution helps us maintain and improve this free tool."
        ...
        >
          <div className="bg-slate-700 transition-all duration-300 hover:scale-[1.03] flex flex-col gap-4 text-white rounded-xl p-4">
            ...
            <div className="bg-gradient-to-l p-3 text-center  rounded-xl to-blue-500 from-blue-300 cursor-pointer hover:to-blue-600 hover:from-blue-400">
              <h1 className="font-bold">📋 Copy Airtm Account</h1>
            </div>
          </div>
          ...
          <div className="bg-slate-700 transition-all duration-300 hover:scale-[1.03] flex flex-col gap-4 text-white rounded-xl p-4">
            ...
            <div className="bg-gradient-to-l p-3 text-center  rounded-xl to-purple-800 from-puto-purple-700 cursor-pointer hover:to-purple-900 hover:from-puto-purple-800">
              <h1 className="font-bold">📋 Copy Vodafone Cash Account</h1>
            </div>
          </div>
        </PopUpCard>
      </div>
