...
const EditLinkModel = ({ DefaultValue, Label, Title }: EditLinkModelProps) => {
  return (
    <>
        ...
        <div className="bg-slate-800 text-white shadow-2xl shadow-slate-800 w-[30pc]  p-4 rounded-xl">
          ...
          <form action="" className="mt-4">
            ...
            <div className="mt-4 flex justify-end gap-7">
              <button className="border-1 border-gray-400 p-3 w-28 rounded-xl hover:bg-gray-400 font-bold cursor-pointer transition-all duration-300">
                Cancel
              </button>
              <button
